...
colnames = ['links']
round_links_df = pd.read_csv('mycsv.csv', names=colnames)
...
for rnd in all_rounds:
    ...
    if len(heat_elems) > 0:
        ...
        for elem in heat_htms:
            ...
            df.to_csv("./heat_scores2.csv", mode='a',sep=',',index=False, header = False)
...
# cycle through events and get round id links for 2021
# colnames = ['links']
# event_links_df = pd.read_csv('event_links_2021.csv', names=colnames)
